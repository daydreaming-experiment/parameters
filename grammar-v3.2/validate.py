...
"""Test a parameters file to check it follows grammar v3.2."""
...
class Sequence(FixedKeysObject):
    ...
    def __init__(self, tc, i, loaded, parent):
        ...
        self.showProgressHeader = tc.checkIn(self, loaded, 'showProgressHeader', True)
    ...
    def test_types(self):
        ...
        self.tc.checkInstance(self, 'showProgressHeader', bool, True)
        self.kiddos('test_types')
...
if __name__ == '__main__':
    ...
    # Say hello
    hello = "Validating '{}' against grammar version 3.2".format(basefilename)
    print()
    print(hello)
    print("-" * len(hello))
    print()
